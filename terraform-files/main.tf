...
resource "null_resource" "config" {
  ...
  connection {
    ...
    type = "ssh"
    user = "ec2-user"
    private_key = file("/Users/abdullahyalcin/Downloads/${var.mykey}.cer")
  ...
  provisioner "file" {
    # Do not forget to define your key file path correctly!
    source = "/Users/abdullahyalcin/Downloads/${var.mykey}.cer"
    destination = "/home/ec2-user/${var.mykey}.cer"
  }
